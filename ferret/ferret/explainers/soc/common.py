...
def convert_examples_to_features(
    examples, label_list, max_seq_length, tokenizer, output_mode, configs
):
    ...
    def get_neutral_word_ids():
        f = open(neutral_words_file)
        neutral_words = []
    ...
    neutral_word_ids = []
    if remove_nw:
        neutral_word_ids = get_neutral_word_ids()
        logger.info("Remove neutral words after tokenization...")
